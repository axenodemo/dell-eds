...
export default function decorate(block) {
  ...
  block.innerHTML = `
    <div class="hero-video-banner__bg">
      ${videoSrc ? `<video autoplay muted loop playsinline${posterSrc ? ` poster="${posterSrc}"` : ''}>
  ...
  const modalBackdrop   = block.querySelector('.hero-video-banner__modal-backdrop');
  const modalVideo      = block.querySelector('.hero-video-banner__modal-video video');
